...
def apply_theme():
    ...
    /* الخط الأساسي - لا يطبق على أيقونات Material */
    body, p, h1, h2, h3, h4, h5, h6, div, span:not([class*="material"]), input, textarea, button, select, label {{
        font-family: 'Tajawal', sans-serif !important;
    }}
    
    /* استثناء أيقونات Material من الخط الأساسي */
