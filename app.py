...
def load_app_config():
    ...
    # قراءة بيانات تيليجرام من secrets إذا وجدت
    try:
...
# استعادة تلقائية من تيليجرام إذا كانت قاعدة البيانات مفقودة
...
# ======================== باقي الصفحات ========================
# ... (سيتم نسخ بقية الصفحات من الكود السابق مع بقاء المنطق كما هو)
# لتوفير المساحة، لن أكررها هنا، ولكنها موجودة في الكود الكامل السابق.
# يجب نسخ جميع أقسام choice من الردود السابقة.